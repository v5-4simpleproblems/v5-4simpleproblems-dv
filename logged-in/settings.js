         ...
         */
        function getPrivacyContent(providerData) {
    ...
    rotationSlider.value = mibiAvatarState.rotation;
        ...
        async function loadPrivacyTab() {
            ...
            // =================================================================
            // --- LINKING / UNLINKING PROVIDERS LOGIC (Moved from General) ---
            // =================================================================

            const messageElement = document.getElementById('accountMessage'); // Use the new message area
            ...
            linkProviderButtons.forEach(button => {
                button.addEventListener('click', async () => {
                    ...
                    try {
                        ...
                        setTimeout(() => switchTab('privacy'), 1500); // Refresh UI
                    } catch (error) {
            ...
            // Assuming currentUser is available globally
            const primaryProviderId = currentUser.providerData[0].providerId;

            // Note: performAccountDeletion is defined globally or we need to redefine it here if it's local. 
            // In the previous code it was local to loadGeneralTab.
            // I need to redefine it here.
